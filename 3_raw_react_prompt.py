...
# Change 3: Delete JSON schemas. Tools now live inside the prompt as plain text.
...
def get_tool_descriptions(tools_dict):
  ...
  # because we want to propagate everything to the LLM join descriptions as one big string
  return "\n".join(descriptions)
